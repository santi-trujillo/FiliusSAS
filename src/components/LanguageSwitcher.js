...
export class LanguageSwitcher {
  ...
  updateUI() {
    ...
    buttons.forEach((btn) => {
      ...
      if (flagElement) {
        // Decodificar HTML entities manualmente para banderas usando DOMParser
        const parser = new DOMParser();
        const doc = parser.parseFromString(flag, 'text/html');
        flagElement.textContent = doc.body.textContent;
      }
      if (labelElement) {
